    ...
    public void createEquipmentFromInput() {
        ...
        switch (typeChoice) {
            case 1:
                ...
                newEquipment = new Weapon(weaponName, weaponAttack, weaponDefense, weaponType, weaponSkill, skillDamage, weaponElement,
                        criticalRate);
                break;
            case 2:
                System.out.print("Masukkan Nama Equipment: ");
            ...
            case 3:
                ...
                newEquipment = new Accessory(accessoryName, accessoryAttack, accessoryDefense, accessoryType, attackBonus, healingBonus);
                break;
            default:
                ...
                if (equipmentList.isEmpty()) {
                    ...
                    for (Equipment equipment : equipmentList) {
                        ...
                        if (equipment instanceof Weapon) {
                            ...
                            System.out.println("Weapon Skill: " + weapon.getWeaponSkill());
                            System.out.println("Weapon Element: " + weapon.getWeaponElement());
                            System.out.println("Critical Rate: " + weapon.getCriticalRate());
                            System.out.println("Skill Damage: " + weapon.getSkillDamage());
                        } else if (equipment instanceof Shield) {
                            Shield shield = (Shield) equipment;
                            System.out.println("Damage Reduction: " + shield.getDamageReduction());
                            System.out.println("Health Bonus: " + shield.getHealthBonus());
                            ...
                            System.out.println("Attack Bonus: " + accessory.getAttackBonus());
                            System.out.println("Healing Bonus: " + accessory.getHealingBonus());
                        }
